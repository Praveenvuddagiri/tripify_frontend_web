...
function UpdateImagesForm({ hotel, setHotel, setError, handleClick, setOpenModal, jumpToTab }) {
    const [imagePreview, setImagePreview] = useState(hotel.images);
    ...
    const handleSubmit = async (e) => {
        ...
        if(images.length === 0 && !governmentAuthorizedLicense){
            let successAlert = {
                errorType: 'error',
        ...
        try {
            var response = await axios.put(`${baseAPI}${deleteUpdateHotel}/${hotel._id.toString()}`, {
                images,
                                ...
                                (
                                    <Grid item xs={7} mt={2}>
                                        ...
                                        >
                                            ...
                                            <embed
                                                src={hotel.governmentAuthorizedLicense.secure_url}
                                                type="application/pdf"
                                                width="100%"
                                                height="auto"
                                            />
