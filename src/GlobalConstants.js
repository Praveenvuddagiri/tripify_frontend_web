...
export const getAllRestrauntsAdmin = "api/v1/admin/restaurant/all";
export const approveRestrauntAdmin = "api/v1/admin/restaurant/approve";
export const unapproveRestrauntAdmin = "api/v1/admin/restaurant/unapprove";
